...
# read models
beast_1 <- read_csv("app/models4/rbeast_time5_1_10cp.csv")
beast_2 <- read_csv("app/models4/rbeast_time5_2_10cp.csv")
beast_3 <- read_csv("app/models4/rbeast_time5_3_10cp.csv")
